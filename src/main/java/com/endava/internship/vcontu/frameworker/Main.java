...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        final Translator enRoTranslator = new EnglishToRomanianTranslator();

        final NewsPublisher standardPublisher = new NewsPublisher(
            enRoTranslator,
            new PunctuationEditor(),
            new ConsolePublisher(enRoTranslator));

        final Translator enRuTranslator = new EnglishToRussianTranslator();
        final NewsPublisher alternativePublisher = new NewsPublisher(
            enRuTranslator,
            new PunctuationEditor(),
            new ConsolePublisher(enRuTranslator));
        ...
        final OriginalStory originalStory2 = new OriginalStory(HELLO, JOHN_DOE_AUTHOR);
